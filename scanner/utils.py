...
def scan_directory(directory):
    """
    Сканирует указанную директорию, извлекает информацию о файлах и сохраняет их в базу данных.

    Функция проходит по всем файлам в указанной директории, извлекает их атрибуты
    (размер, расширение, дополнительные параметры для изображений и PDF) и сохраняет
    их в базу данных.

    :param directory: Путь к директории, которую нужно просканировать.
    """
